...
PersistentStorage::PersistentStorage(BakkesMod::Plugin::BakkesModPlugin* plugin, const std::string& storage_file_name, const bool auto_write, bool auto_load):
...
CVarWrapper PersistentStorage::RegisterPersistentCvar(
...
PersistentStorage::CvarCacheItem::CvarCacheItem(CVarWrapper cvar): value(cvar.getStringValue()), description(cvar.getDescription())
{
}